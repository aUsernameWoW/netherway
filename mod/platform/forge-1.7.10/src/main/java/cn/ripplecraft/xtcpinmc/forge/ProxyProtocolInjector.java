...
import cn.ripplecraft.xtcpinmc.core.ProxyProtocol;
...
final class ProxyProtocolInjector {
    ...
    private static final String ACCEPTOR_NAME = "xtcpinmc_pp_acceptor";
    private static final String HANDLER_NAME = "xtcpinmc_proxy_protocol";
