...
public final class ClientEvents {
    ...
    public void onConnected(FMLNetworkEvent.ClientConnectedToServerEvent event) {
        ForgeClientBridge.ConnectResult result = bridge.connectionOpened(event.getManager());
        ...
        Credentials warm = warmupMatch(event.getManager());
        if (warm != null
    ...
    public void onDisconnected(FMLNetworkEvent.ClientDisconnectionFromServerEvent event) {
        ForgeClientBridge.DisconnectResult result = bridge.connectionClosed(event.getManager());
