...
public final class Netherway {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        net.minecraftforge.common.MinecraftForge.EVENT_BUS.register(new CredentialSender(channel, config));
    ...
    public void serverStarted(FMLServerStartedEvent event) {
        ...
        ConnectionSniffer.install(FMLCommonHandler.instance().getMinecraftServerInstance(),
