...
/**
 * Forge 1.20.1 入口（服务端半边 + 公共装配）。客户端半边在
...
public final class NetherwayForge {
    ...
    public NetherwayForge() {
        ...
        this.channel = NetworkRegistry.ChannelBuilder
                ...
                .eventNetworkChannel();
        // 服务端收客户端回传的升级结果。NetworkEvent.getSource() 是
        // Supplier<Context>，取 Context 要先 .get()。
    ...
    public void onPlayerJoin(PlayerEvent.PlayerLoggedInEvent event) {
        ...
        // 发包走 vanilla custom payload：connection.send 与该包构造在 1.20.1 稳定，
        // 避开 Forge 各 47.x 小版本间 channel.send 签名的反复。没装 mod 的客户端
        // 收到未知频道会静默忽略。
