...
/**
 * Forge 1.20.1 客户端半边。经 {@link net.minecraftforge.fml.DistExecutor} 只在
...
public final class NetherwayForgeClient {
    ...
    public static void init(ModConfig config, EventNetworkChannel channel) {
        ...
        // 服务端下发的凭证（客户端方向）。getSource() 是 Supplier<Context>。
    ...
    public void onLoggingIn(ClientPlayerNetworkEvent.LoggingIn event) {
        // 1.20.1：LoggingIn/LoggingOut（1.19.3 起改名，早前叫 LoggedIn/LoggedOut）
    ...
    public void onLoggingOut(ClientPlayerNetworkEvent.LoggingOut event) {
        // LoggingOut 的字段可空，且新建集成服务器时也会触发——都交给
