...
public final class Platform {
    ...
    /** jar 内资源路径，例如 {@code natives/windows-amd64/xtcpinmc.exe}。 */
    public String resourcePath() {
        return "natives/" + os.token + "-" + arch.token + "/xtcpinmc" + os.exeSuffix;
    }

    /** 释放到磁盘后的文件名。 */
    public String executableName() {
        return "xtcpinmc-" + os.token + "-" + arch.token + os.exeSuffix;
    }
