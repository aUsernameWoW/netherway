...
//
//	Pre-launch:  netherway start
//	Post-exit:   netherway stop
//
...
func stateDir() (string, error) {
	...
	dir := filepath.Join(base, "netherway")
...
func pidFilePath() (string, error) {
	...
	return filepath.Join(dir, "netherway.pid"), nil
}
...
func cmdStart(args []string) error {
	...
	logPath := filepath.Join(dir, "netherway.log")
